...
class SettingController extends AppBaseController
{
    ...
    public function index(Request $request): \Illuminate\View\View
    {
        ...
        return view(
            ...
            compact('setting', 'selectedPaymentGateways', 'metas', 'sectionName', 'paymentGateways', 'paypalMode', 'mailsetting', 'customDomain', 'social_setting')
        );
    }
    ...
    public function changeThemeColor(Request $request)
    {
        ...
        Flash::success($colorName . ' color changed successfully');

        return redirect()->back()->with('success', __($colorField === 'primary_color'
            ? 'Primary color changed successfully'
