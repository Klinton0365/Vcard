    ...
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            ...
            @if ((isset($managesection) && $managesection['banner']) || empty($managesection))
                ...
                @endif
            @endif
            <div class="banner-section position-relative @if($vcard->cover_type == 2) banner-img-23 @endif">
            ...
            {{-- profile seciton --}}
            <div class="profile-section px-40 @if($vcard->cover_type == 2) profile-margin @endif">
            ...
            @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
                <div class="contact-section mx-md-3 px-40 mb-5" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    <div class="row">
                        @if ($vcard->email)
                            <div class="col-sm-6 mb-5 px-lg-4 px-sm-3">
                                <div class="contact-box">
                                    <div class="contact-icon d-flex justify-content-center align-items-center">
                                        <img src="{{ asset('assets/img/vcard23/email.png') }}" loading="lazy" />
                                    </div>
                        ...
                        @if ($vcard->phone)
                            <div class="col-sm-6 mb-5 px-lg-4 px-sm-3">
                                <div class="contact-box">
                                    <div class="contact-icon d-flex justify-content-center align-items-center">
                                        <img src="{{ asset('assets/img/vcard23/phone.png') }}" loading="lazy" />
                                    </div>
                                    <div class="contact-desc">
                                        <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}"
                                            class="text-secondary fs-14 fw-5" dir="ltr">+{{ $vcard->region_code }}{{ $vcard->phone }}</a>
                                    </div>
                                </div>
                            </div>
                        @endif
                                ...
                                <div class="contact-box">
                                    ...
                                    <div class="contact-desc">
                                        <a href="tel:+{{ $vcard->alternative_region_code }}{{ $vcard->alternative_phone }}"
                                            class="text-secondary fs-14 fw-5" dir="ltr">+{{ $vcard->alternative_region_code }}{{ $vcard->alternative_phone }}</a>
                                    </div>
                                </div>
                            </div>
                        @endif
                        @if ($vcard->dob)
                            <div class="col-sm-6 mb-sm-0 mb-5 px-lg-4 px-sm-3">
                                <div class="contact-box">
                                    <div class="contact-icon d-flex justify-content-center align-items-center">
                                        <img src="{{ asset('assets/img/vcard23/dob.png') }}" loading="lazy" />
                                    </div>
                                    <div class="contact-desc">
                        ...
                        @if ($vcard->location)
                            <div class="col-sm-6 px-lg-4 px-sm-3">
                                <div class="contact-box">
                                    <div class="contact-icon d-flex justify-content-center align-items-center">
                                        <img src="{{ asset('assets/img/vcard23/location.png') }}" loading="lazy" />
                                    </div>
                                    <div class="contact-desc">
                            ...
                            @if ($vcard->services_slider_view)
                                <div class="row services-slider-view">
                                    @foreach ($vcard->services as $service)
                                        <div>
                                            <div class="service-card my-4 h-100">
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-60 px-40 mb-5">
                        ...
                        <div class="appointment px-2">
                            <div class="mb-20">
                                <label for="date"
                                    class="appoint-date d-block text-secondary fs-6 fw-5 mb-1 text-start">{{ __('messages.date') }}</label>
                                <div class="row">
                            ...
                            <div class="">
                                <label
                                    class="text-secondary d-block fs-6 fw-5 mb-1 text-start">{{ __('messages.hour') }}</label>
                                <div class="mb-40">
                                    <div class="row">
                                        <div class="">
                                ...
                                <div class="text-center px-sm-4 mx-sm-3 mx-2">
                                    <button type="submit" class="appointmentAdd btn btn-primary w-100 rounded d-none">
            ...
            @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-60 pb-50">
                        <div class="section-heading text-center mb-40">
            ...
            @if ((isset($managesection) && $managesection['testimonials']) || empty($managesection))
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-60 px-40 pb-30 mb-4">
                        <div class="testimonial-bg-img">
                            <img src="{{ asset('assets/img/vcard23/testimonial-bg.png') }}" loading="lazy" />
                        </div>
                        <div class="section-heading text-center mb-40">
                                    ...
                                    <div class="testimonial-card card">
                                        ...
                                        <div class="card-body p-0 pt-3">
                                            <div class="text-center">
                                                <h3 class="text-primary fs-20 mb-0">
                                            ...
                                            <div
                                                ...
                                                <h4 class="text-center text-primary mb-0">
                                                    @if ($product->currency_id && $product->price)
                                                        <span
                                                            class="fs-18 fw-6 text-primary">{{ $product->currency->currency_icon }}{{ getSuperAdminSettingValue('hide_decimal_values') == 1 ? number_format($product->price, 0) : number_format($product->price, 2) }}</span>
            ...
            @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section mt-2 pb-3 pt-60">
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    @endphp
                    <div class="business-hour-section mb-3">
                        <div class="section-heading text-center mb-40">
                            <h2 class="mb-0">{{ __('messages.business.business_hours') }}</h2>
                        </div>
                        <div class="business-hours bg-white" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-us-section px-30 pb-5">
                    <div class="section-heading text-center mb-40">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <input type="tel" class="form-control text-start" name="phone"
                                            placeholder="{{ __('messages.form.phone') }}" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,&quot;&quot;)"/>
                                    </div>
                                    <div class="col-12">
                                    ...
                                    <div class="col-12 text-center mt-2">
                                        <button class="contact-btn send-btn rounded-2 btn btn-primary" type="submit">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="pt-40 pb-40 px-40 pt-0">
                    <div class="bg-img">
                        ...
                        <div class="vcard-link-card card">
                            <div class="d-flex align-items-center justify-content-center">
                                <a href="{{ route('register', ['referral-code' => $vcard->user->affiliate_code]) }}"
                                    class="text-secondary text-start link-text fw-5">{{ route('register', ['referral-code' => $vcard->user->affiliate_code]) }}</a>
                    ...
                    <div class="text-center d-flex align-items-center justify-content-center"
                        ...
                        @if ($contactRequest == 1)
                            <a href="{{ Auth::check() ? route('add-contact', $vcard->id) : 'javascript:void(0);' }}"
                                class="add-contact-btn rounded-2 btn-primary
            ...
            <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
                <div class="fixed-btn-section">
                    @if (empty($vcard->hide_stickybar))
                        <div
                            class="bars-btn consulting-bars-btn @if (getLanguage($vcard->default_language) == 'Arabic') vcard-bars-btn-left @endif">
                            <img src="{{ asset('assets/img/vcard23/sticky-btn.png') }}" loading="lazy" />
                        </div>
                    @endif
                    ...
                    <div class="modal-dialog news-modal modal-dialog-centered">
                        <div class="modal-content animate-bottom" id="newsLatter-content">
                            ...
                            <div class="modal-body">
                                <h1 class="content text-start mb-2">{{ __('messages.vcard.subscribe_newslatter') }}
                                </h1>
