@role(App\Models\Role::ROLE_SUPER_ADMIN)
    ...
    <li class="nav-item {{ Request::is('sadmin/blogs*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3" aria-current="page" href="{{ route('blogs.index') }}">
            <span class="aside-menu-icon pe-3"><i class="fas fa-book icon-color-bs-purple"></i></span>
...
@role(App\Models\Role::ROLE_ADMIN)
	...
	{{-- <li class="user-dashboard nav-item {{ Request::is('admin/dashboard*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3" aria-current="page" href="{{ route('deepseek.index') }}">
            <span class="aside-menu-icon pe-3"><i class="fas fa-chart-pie icon-color-bs-blue"></i></span>
            <span class="aside-menu-title">{{ __('Deepseek GEN') }}</span>
        </a>
    </li> --}}
    ...
    @if (getPlanFeature(getCurrentSubscription()->plan)['whatsapp_store'])
        <li class="vcard-option nav-item {{ Request::is('admin/whatsapp-stores*') ? 'active' : '' }}">
            <a class="nav-link d-flex align-items-center py-3" aria-current="page"
                href="{{ route('whatsapp.stores') }}">
                <span class="aside-menu-icon pe-3"><i class="fab fa-whatsapp"></i></span>
    ...
    @if (getNfcCard()->count() > 0)
        <li class="nav-item {{ Request::is('admin/my-nfc-cards*') ? 'active' : '' }}">
            <a class="nav-link d-flex align-items-center py-3" aria-current="page" href="{{ route('user.orders') }}">
    ...
    <li class="{{ Request::is('admin/manage-subscription*') ? 'active' : '' }} fixed">
        <div class="card bg-light m-2">
            <a class="nav-link d-flex align-items-center py-3" aria-current="page"
                ...
                <span class="aside-menu-icon pe-3"><i class="fa-regular fa-gem icon-color-bs-red"></i></span>
                <span
