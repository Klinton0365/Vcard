<div class="aside-menu-container" id="sidebar">
    <div class="aside-menu-container__aside-logo flex-column-auto">
        <a data-turbo="false" href="{{ url('/') }}" class="text-decoration-none sidebar-logo" target="_blank">
            <div class="image image-mini me-3">
				...
				<img src="{{ asset('assets/images/favicon-icon.png') }}" alt="Logo" class="object-fit-cover sidebar-app-logo" />
            </div>
            <span
    ...
    <form class="d-flex position-relative aside-menu-container__aside-search search-control py-3 mt-1">
        <div class="position-relative w-100">
            <input class="form-control" type="text" placeholder="{{ __('auth.app.search') }}" aria-label="Search"
                id="menuSearch">
    ...
    <div class="sidebar-scrolling {{ Request::is('admin*') ? 'pb-15' : '' }}">
