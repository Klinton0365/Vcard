@role(App\Models\Role::ROLE_SUPER_ADMIN)
    ...
    <li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('sadmin/blogs*') ? 'd-none' : '' }}">
        <a class="nav-link p-0 {{ Request::is('sadmin/blogs*') ? 'active' : '' }}"
            href="{{ route('blogs.index') }}">{{ __('messages.blogs') }}</a>
    </li>
...
{{ !Request::is(
    ...
    <li
        class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0
    {{ Request::is('sadmin/coupon-codes*') || Request::is('sadmin/used-coupon-code*') ? '' : 'd-none' }}">
    ...
    <li
        class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ Request::is('sadmin/used-coupon-code*') || Request::is('sadmin/coupon-codes*') ? '' : 'd-none' }}">
        <a class="nav-link p-0 {{ Request::is('sadmin/used-coupon-code*') ? 'active' : '' }}"
            href="{{ route('used-coupon-code.index') }}">{{ __('messages.coupon_code.used_coupon_codes') }}</a>
    </li>
@endrole
...
@role(App\Models\Role::ROLE_ADMIN)
    ...
    <li
        class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('admin/whatsapp-stores*') ? 'd-none' : '' }}">
        <a class="nav-link p-0 {{ Request::is('admin/whatsapp-stores*') ? 'active' : '' }}"
            href="{{ route('whatsapp.stores') }}">{{ __('messages.whatsapp_stores.whatsapp_stores') }}</a>
    </li>
    ...
    <li
        class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('admin/virtual-backgrounds*') ? 'd-none' : '' }}">
...
<li
    class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('admin/product-orders*') ? 'd-none' : '' }}">
    <a class="nav-link p-0 {{ Request::is('admin/product-orders*') ? 'active' : '' }}"
        href="{{ route('product-orders.index') }}">{{ __('messages.product_orders') }}</a>
</li>
<li
    class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('admin/vcard/subscribers/*') ? 'd-none' : '' }}">
...
<li
    class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('admin/vcard/contact/*') ? 'd-none' : '' }}">
    <a class="nav-link p-0 {{ Request::is('admin/vcard/contact/*') ? 'active' : '' }}"
        href="">{{ __('messages.vcard.vcard_contact_download') }}</a>
</li>
<li
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ Request::is('admin/my-nfc-cards*') ? '' : 'd-none' }}">
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ Request::is('admin/storage*') ? '' : 'd-none' }}">
